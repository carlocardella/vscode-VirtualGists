...
import { addFile, closeGist, createGist, deleteFile, deleteGist, followUser, openGist, renameFile, starGist, unstarGist, uploadFiles, copyGistId, copyGistUrl, openGistOnGitHub } from './GitHub/commands';
declare global {
